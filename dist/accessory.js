    ...
    setMqttEvent() {
        this.mqttClient.on("message", (topic, message) => {
            if (topic === this.topicStatus) {
                ...
                if (setValue == true) {
                    this.deviceService.getCharacteristic(homebridge_1.Characteristic.LockCurrentState).updateValue(this.deviceOnOff, undefined, 'fromSetValue');
                    this.deviceService.getCharacteristic(homebridge_1.Characteristic.LockTargetState).updateValue(this.deviceOnOff, undefined, 'fromSetValue');
                    setValue = false;
